...
function wpspf_pr_search_by_title(){
    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){
            jQuery("#wpspf_pr_result_close").click(function(){
                jQuery("#wpsps_pr_title_search_result").html('');
                jQuery("#wpsps_pr_title_search_result").hide();
            });
            ...
            jQuery("a.switcher").bind("click", function(e){
                ...
                if(jQuery(this).hasClass("active")) {
                    ...
                    if(theid == "gridview") {
                        ...
                        jQuery("#listview").children("img").attr("src","<?php echo WPSPF_AST_PATH; ?>/list-view.png");
                        ...
                        jQuery("#gridview").children("img").attr("src","<?php echo WPSPF_AST_PATH; ?>/grid-view.png");
...
function wpspf_get_all_attributes(){
    ...
    <div class="form-group row">
        <label for="wpspf_attr_status" class="col-sm-2 col-form-label col-form-label-sm">
            Status
        </label>
        <div class="col-sm-6">
    ...
    <div class="form-group row">
        <label for="wpspf_attr_reset" class="col-sm-2 col-form-label col-form-label-sm">
            Reset
        </label>
        <div class="col-sm-6">
    ...
    <div class="form-group row">
        <label for="wpspf_attr_title" class="col-sm-2 col-form-label col-form-label-sm">
            Title
        </label>
        <div class="col-sm-4">
    ...
    <div class="form-group row">
        <label for="wpspf_attr_tax_id" class="col-sm-2 col-form-label col-form-label-sm">
            Attribute
        </label>
        <div class="col-sm-6">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6 wpspf_assign_color_feld_<?php echo $counter; ?>" style="display:none;">
            <br>
            <h4>Assign color field</h4>
            <?php $cv_counter = 1; ?>
            <?php foreach($attribute_taxonomies as $tax){?>
            <div id="pa_<?php echo $tax->attribute_id; ?>_<?php echo $counter; ?>" style="display:none;" class="wpspf_tax_color_field_<?php echo $counter; ?>">
                ...
                ?>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label col-form-label-sm"><?php echo $term->name; ?></label>
    ...
    <script type="text/javascript">
        jQuery('.wpspf_terms_assign_color').wpColorPicker();
    </script>
    <?php
    exit;
}
